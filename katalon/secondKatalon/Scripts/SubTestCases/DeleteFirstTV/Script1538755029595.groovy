...
WebUI.click(findTestObject('Page_SmartInstall - Manage TV  IP s/label_DeleteSelected'))

WebUI.delay(5)

'Press the OK button of the Delete TV dialog'
WebUI.click(findTestObject('Page_SmartInstall - Manage TV  IP s/Delete_Selected_TVs_dialog/button_ok_1'))
