...
'Open the SW dropdown list'
WebUI.click(findTestObject('Page_SmartInstall - Manage TV  IP s/button_None_SwDropDownList'))

WebUI.delay(5)

'Select the first SW of the list'
WebUI.click(findTestObject('Page_SmartInstall - Manage TV  IP s/span_select_first_sw_from_SwDropDownList'))
